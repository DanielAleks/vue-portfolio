...
const AdminImplementationTypeQuery = gql`
...
const AdminImplementationTypesQuery = gql`
...
const AdminImplementationTypeQueryHierarchy = gql`
  query AdminImplementationType($id: Int!) {
    AdminImplementationType(id: $id) {
      id
      Name
...
const AdminImplementationTypeQuery_AdminImplementationGuidelines = gql`
  query AdminImplementationType($id: Int) {
    AdminImplementationType(id: $id) {
      id
      AdminImplementationGuidelines {
...
export {
  ...
  AdminImplementationTypesQuery,
  AdminImplementationTypeQueryHierarchy,
  AdminImplementationTypeQuery_AdminImplementationGuidelines,
};
