      ...
      <q-card-section class="col flex flex-col">
        ...
        <p
                ...
                >
                  ...
                  {{ state.billingUnitType.split(/(?=[A-Z])/).join(" ") }} Guideline (attaches the associated Product/Service)
                </p>
      </q-card-section>
        ...
        <div class="">
          <div style="width: 100%; overflow: hidden">
            ...
            <q-input
              ...
              type="number"
              filled
              :label="state.name.includes('Discount') ? 'One-Time Discount' : 'Price Override'"
              :dark="darkmode"
              :class="darkmode ? 'bg-[#202a46]' : ''"
            />
            ...
            >
              ...
              <div class=" flex flex-col mt-0 sm:mt-3 ml-[-.5rem]" :class="windowWidth < 475 ? '-mt-8' : 'absolute'">
                <q-toggle
                  v-if="
