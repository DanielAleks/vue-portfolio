<template>
  <!-- merge of AccordianQTableSowDeep and AccordianQTableSowGuidelineDeep -->
  <q-markup-table
  ...
  >
    <thead>
      <div class="w-full flex justify-center items-center">
        ...
        <q-toggle
          v-if="(idx === 0 || idx === null) && showHeaderToggle"
      ...
      <q-tr class="grid" :class="'grid-cols-' + (columns.length + (title === 'Sow Project View' ? 0 : 1))">
        <q-th
      ...
      <div class="w-[100%] grid grid-cols-1">
        <div
          v-for="(expansionItem, expansionIdx) in expansionHeaders.filter(
            (item) => item.relatedItems && item.relatedItems.length > 0
          )"
          :key="expansionIdx"
        >
          ...
          <q-expansion-item
            v-if="
              byPassExpansionConditionals ? expansionItem.relatedItems.length > 0 :
            ...
            <template #header>
              ...
              >
                ...
                <div class="flex items-center absolute right-5">
                  ...
                  <q-btn
                    v-if="expansionItem.implementation_guideline_id"
                    label="View"
                    dense
                    color="blue"
                    flat
              ...
              <div class="bg-[#E3F2FD] dark:bg-[#28334E]">
                ...
                >
                  <q-expansion-item
                    v-if="
                      ...
                      (title.includes(innerExpansionItem.SowImplementationTypeName) ||
                        !route.path.includes('sow_details/') ||
                        innerExpansionItem.phaseID === expansionItem.id) &&
                    ...
                    <template #header>
                      ...
                      >
                        ...
                        <div class="flex items-center absolute right-5">
                          <p class="mr-24">{{ expansionItem.SkillTier }}</p>
                          <q-btn
                            v-if="innerExpansionItem.id !== undefined"
                            label="View Task"
                            dense
                            color="blue"
                            flat
                            ...
                            class="px-2 -mt-1"
                            tag="a"
                            :to="redirectToTask + innerExpansionItem.id"
                            target="_blank"
                          />
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <q-td
                      v-if="columns.some((col) => col.name === 'isRecurring' || col.name === 'block')"
                    ...
                    <q-td
                      v-if="columns.some((col) => col.name === 'skillName')"
                      class="flex items-center justify-center"
                    >
                      {{ innerExpansionItem.SkillTier ?? "N/A" }}
                    </q-td>
                    <q-td class="absolute right-0 -mt-1 flex justify-end">
                      <q-btn
                        v-if="innerExpansionItem.id !== undefined"
                        label="View Task"
                        dense
                ...
                <q-tr
                  ...
                  "
                  class="bg-[#232D45] hover:bg-[#414D6D] active:bg-[#354161] cursor-pointer"
          ...
          <q-tr v-else class="grid border-t grid-cols-5">
            ...
            <q-td class="col-span-1 flex items-center justify-end">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    function setShowRelatedTasksTable(val) {
      // state.showRelatedTasksTable = val;
