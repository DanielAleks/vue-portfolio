...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("src/pages/AccountOverview.vue"),
        beforeEnter: beforeEnterFunction,
      },
      {
        path: "projects",
      ...
      },
      {
        ...
        component: () => import("pages/RoadmapOverview.vue"),
        meta: { layout: ListLayout },
        beforeEnter: beforeEnterFunction,
      },
      {
        path: "account/roadmap/:id",
        name: "RoadmapDetails",
        component: () => import("pages/RoadmapDetails.vue"),
      ...
      {
        path: "implementation-type/skill/:id",
        name: "GuidelineSkillDetails",
        meta: { layout: PreviewLayout },
      ...
      },
      {
        path: "tasks",
        name: "Tasks",
        component: () => import("pages/ATTaskOverview.vue"),
        meta: { layout: ListLayout },
        beforeEnter: beforeEnterFunction,
      },
      {
        ...
        name: "Project Task",
        component: () => import("pages/ATTaskDetails.vue"),
        meta: { layout: PreviewLayout },
        beforeEnter: beforeEnterFunction,
      },
      {
      ...
      },
      {
        ...
        component: () => import("src/pages/VulnerabilityScans.vue"),
        beforeEnter: beforeEnterFunction,
        meta: { layout: ListLayout },
      },
      {
        path: "vulnerability-scan-details/:id",
        name: "Vulnerability Scan Details",
        component: () => import("src/pages/VulnerabilityScanDetails.vue"),
        beforeEnter: beforeEnterFunction,
        meta: { layout: PreviewLayout },
      },
      {
        path: "vulnerability-scan/account-schedule/:id",
        name: "Account Schedule",
        component: () => import("src/pages/AccountScheduleDetails.vue"),
        beforeEnter: beforeEnterFunction,
        meta: { layout: PreviewLayout },
      },
      {
        ...
        component: () => import("src/pages/PhonesVoIP.vue"),
        beforeEnter: beforeEnterFunction,
        meta: { layout: ListLayout },
      },
      {
