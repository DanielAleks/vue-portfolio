...
const AdminImplementationTaskQuery = gql`
...
const AdminImplementationTasksQuery = gql`
...
const AdminImplementationTaskQueryHierarchy = gql`
  query AdminImplementationTask($id: Int!) {
    AdminImplementationTask(id: $id) {
      id
      Name
...
export { AdminImplementationTaskQuery, AdminImplementationTasksQuery, AdminImplementationTaskQueryHierarchy };
